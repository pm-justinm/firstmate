...
4. Report status by appending one line:
   `echo "{state}: {one short line}" >> '/var/folders/nv/q5l3qllj3nb4nf3dj9k004rm0000gp/T/no-mistakes-evidence/01M093V8NHTRTX8XW2TYVWCABK/brief-fixture/home/state/evidence-brief.status'`
...
# Project memory
If `AGENTS.md` or `CLAUDE.md` already exists, or if this task produced durable project-intrinsic knowledge, run `/Users/earljustinmangulabnan/.no-mistakes/worktrees/71e1e4780335/01M093V8NHTRTX8XW2TYVWCABK/bin/fm-ensure-agents-md.sh .` in the worktree.
Record only project knowledge useful to almost every future session.
For anything the codebase already shows, prefer a pointer to the authoritative file, command, or doc over copying the detail.
If you touch a project `AGENTS.md` that lacks `## Maintaining this file`, add that short self-governance section from `/Users/earljustinmangulabnan/.no-mistakes/worktrees/71e1e4780335/01M093V8NHTRTX8XW2TYVWCABK/bin/fm-ensure-agents-md.sh` in the same pass.
